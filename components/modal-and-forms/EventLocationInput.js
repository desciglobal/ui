          ...
          <div className="relative">
            <input
              {...getInputProps({
                ...
                className:
                  "form-input block w-[97%] px-0.5 border-0 border-b border-black focus:ring-0 focus:border-black",
              })}
            />
            {!!suggestions.length && (
              <div
                class="absolute left-0 bottom-[110%] z-10 mt-2 w-[97%] origin-bottom-right rounded-md bg-white shadow-lg shadow-zinc-400 ring-1 ring-black ring-opacity-5 focus:outline-none"
                role="menu"
